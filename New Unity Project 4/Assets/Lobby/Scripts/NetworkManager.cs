...
public class NetworkManager : MonoBehaviour
{
	...
	void sendData()
	{
		...
		NetworkTransport.Send(localHostID, connectionID, stateUpdateChannelID, messageArray, messageArray.Length, out error);
	}
	...
	void onApplicationQuit()
	{
		...
		NetworkTransport.Disconnect(localHostID, connectionID, out error);
